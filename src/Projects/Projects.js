...
// creates feature box div and is updated by functions to change state
    openBox = () => {
        return (
    ...
    handlePtech = () => {
          this.setState({
            ...
            gitLink: "https://github.com/StevenS125/piranhatech",
            siteLink: "https://www.piranhatechnologies.com/#/"
    ...
    handleSTT = () => {
        this.setState({
          ...
          gitLink: "https://github.com/StevenS125/straighttalktoday",
          siteLink: "http://www.straighttalktoday.com/#/"
        })
    }
    ...
    handleCM = () => {
        this.setState({
          ...
          gitLink: "https://github.com/StevenS125/ContactManager",
          siteLink: "https://github.com/StevenS125/ContactManager"
        })
    }
    ...
    handleForex = () => {
        this.setState({
          ...
          gitLink: "https://github.com/StevenS125/fxMan",
          siteLink: "https://thawing-gorge-29999.herokuapp.com/#/login?_k=53jw1c"
        })
    }
    ...
    handleCollege = () => {
        this.setState({
          ...
          gitLink: "https://github.com/StevenS125/collegeApp",
          siteLink: "https://collegespot.herokuapp.com/"
        })
    }
    ...
    handleKK = () => {
        this.setState({
          ...
          gitLink: "https://github.com/StevenS125/kimskustoms",
          siteLink: "https://kimskustoms.herokuapp.com/"
        })
    }
